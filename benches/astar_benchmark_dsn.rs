...
pub fn benchmark(c: &mut Criterion) {
    ...
    let mut destinations = Vec::from_iter(0..=10);
            ...
            group.bench_function(&experiment_name, |b| {
                b.iter_batched(
                    || {
                        ...
                        fs::create_dir(format!("benches/results/{}", &destination.to_string()));
                    ...
                    |mut router| {
                        black_box(router.route(
                            ...
                            Some(format!("benches/results/{}/{}.txt", &destination.to_string(), router_name))
                        ));
                    },
