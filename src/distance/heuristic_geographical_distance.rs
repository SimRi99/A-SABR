...
pub struct HeuristicGeoDistance {}

impl<NM: NodeManager, CM: ContactManager> Distance<NM, CM> for HeuristicGeoDistance {
    ...
    fn cmp(first: &RouteStage<NM, CM>, second: &RouteStage<NM, CM>) -> Ordering {
        if first.cumulative_distance_heuristic > second.cumulative_distance_heuristic {
            return Ordering::Greater;
        } else if first.cumulative_distance_heuristic < second.cumulative_distance_heuristic {
...
impl<NM: NodeManager, CM: ContactManager> HybridParentingOrd<NM, CM> for HeuristicGeoDistance {
